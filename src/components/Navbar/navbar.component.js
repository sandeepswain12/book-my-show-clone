    ...
    return (
        ...
        <div className="text-white flex items-center justify-between">
            <div>
                ...
                <span className="text-grey-400 text-xs flex items-center">Bhubaneswar <BiChevronRight /></span>
            </div>
...
const NavMd = () => {
    return(
        <>
        <div className="w-full flex items-center bg-white gap-3 px-3 py-2">
            <BiSearch />
            <input type="search" className="w-full focus:outline-none"
...
const Navbar = () => {
    return (
        <>
            <nav className="bg-sandeep-700 px-4 py-2">
